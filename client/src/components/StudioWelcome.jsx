    ...
    <div className="studio-welcome studio-only">
      ...
      <div className="studio-cover" aria-hidden="true">
        ...
        <svg className="studio-field-art" viewBox="0 0 640 290" fill="none">
          ...
          {[[130,145,'1'],[232,65,'3'],[211,117,'4'],[211,180,'5'],[232,229,'2'],[305,94,'6'],[305,205,'8'],[375,145,'10'],[418,63,'7'],[456,145,'9'],[418,227,'11']].map(([x,y,n]) => <g key={n}><circle cx={x} cy={y} r="16" fill={n === '10' ? '#d3ee91' : '#f4f2ed'} /><text x={x} y={Number(y)+4} textAnchor="middle" fill="#183126" fontSize="11" fontWeight="800" fontFamily="Arial, sans-serif">{n}</text></g>)}
        </svg>
